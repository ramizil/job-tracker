...
PITCH_RECRUITER_PATH = PROFILE_DIR / "pitch_recruiter.md"
PITCH_RECRUITER_HTML_PATH = PROFILE_DIR / "pitch_recruiter.html"
...
DEFAULT_WEB_SEARCH_SITES = ("comeet.com, greenhouse.io, jobs.lever.co, "
...
def reload() -> None:
    ...
    global DB_PATH, PROFILE_PATH, PITCH_PATH, PITCH_HTML_PATH
